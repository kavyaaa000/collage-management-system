      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route path="contests/:contestId/participate" element={<ContestParticipationPage />} />
            <Route path="contests/:contestId/mcq" element={<MCQTestPage />} />
            <Route path="contests/:contestId/code/:problemId" element={<CodeChallengePage />} />
            ...
            <Route element={<RoleRoute roles={['HOD', 'ADMIN']} />}>
              <Route path="/contests/:id/approve" element={<ApproveContestPage />} />
            </Route>
